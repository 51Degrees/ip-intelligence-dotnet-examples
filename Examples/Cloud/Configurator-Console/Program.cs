...
/// </summary>
namespace FiftyOne.IpIntelligence.Examples.Cloud.Configurator
{
        ...
        public class Example
        {
            ...
            public void Run(TextWriter output)
            {
                ...
                using (var data = _pipeline.CreateFlowData())
                {
                    ...
                    output.WriteLine($"device.IsMobile: {device.RegisteredName.Value}");
                }
            }
            ...
            public static void Run(string resourceKey, TextWriter output)
            {
                ...
                using (var serviceProvider = new ServiceCollection()
                    ...
                    .AddTransient<IpiPipelineBuilder>()
                    // Add a factory to create the singleton IPipeline instance
                    .AddSingleton((x) =>
                        x.GetRequiredService<IpiPipelineBuilder>()
